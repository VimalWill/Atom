...
<head>
    <style>
        ...
        .pillars {{ display: flex; gap: 8px; margin-top: 14px; flex-wrap: wrap; }}
        .pillar {{ background: rgba(255,255,255,0.2); border-radius: 20px;
...
<body>
    <div class="header">
        ...
        <div class="pillars">
            <span class="pillar">🧮 Theory</span>
            <span class="pillar">🔧 Compilers</span>
            <span class="pillar">⚡ Hardware</span>
            <span class="pillar">📐 Algorithms</span>
        </div>
    </div>
"""
